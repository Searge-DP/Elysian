...
public class Elysian {
	...
	public void preInit(FMLPreInitializationEvent pre) {
		...
		DimensionManager.registerProviderType(ConfigurationHandler.dimensionID,
				WorldProviderElysian.class, true);
		DimensionManager.registerDimension(ConfigurationHandler.dimensionID,
