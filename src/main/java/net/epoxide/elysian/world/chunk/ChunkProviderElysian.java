...
public class ChunkProviderElysian implements IChunkProvider {
    ...
    public void prepareChunk (int posX, int posZ, Block[] chunkBlocks) {
        ...
        this.noiseField = this.initializeNoiseField(this.noiseField, posX * four, 0, posZ * four, five_a, sevenTeen, five_b);// empty
                                                                                                                             // nosie
                                                                                                                             // array,
                                                                                                                             // position,
                                                                                                                             // size
                        ...
                        if (block2 != null && block2.getMaterial() != Material.air) {
                            ...
                            if (block2 == generalFiller) {
                                ...
                                if (worldHeight == 126) {
                                    ...
                                    chunkBlocks[chunkSize2] = biome.fillerBlock; // fix for
                                                                                 // topblock
                                                                                 // under
                                                                                 // bedrock
                                }
    ...
    public Chunk provideChunk (int p_73154_1_, int p_73154_2_) {
        ...
        this.biomesForGeneration = this.worldObj.getWorldChunkManager().loadBlockGeneratorData(this.biomesForGeneration, p_73154_1_ * 16, p_73154_2_ * 16, 16, 16); // Forge
                                                                                                                                                                    // Move
                                                                                                                                                                    // up
                                                                                                                                                                    // to
                                                                                                                                                                    // allow
        ...
        // this.genNetherBridge.func_151539_a(this, this.worldObj, p_73154_1_, p_73154_2_,
        // ablock);
