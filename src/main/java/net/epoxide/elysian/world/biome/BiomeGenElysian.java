...
public class BiomeGenElysian extends BiomeGenBase {
	...
	public List getSpawnableList(EnumCreatureType creatureType) {
		...
		return creatureType == EnumCreatureType.monster ? this.spawnableMonsterList
				: (creatureType == EnumCreatureType.creature ? this.spawnableCreatureList
						: (creatureType == EnumCreatureType.waterCreature ? this.spawnableWaterCreatureList
								: (creatureType == EnumCreatureType.ambient ? this.spawnableCaveCreatureList
										: null)));
	}
	...
	public void genTerrainBlocks(World p_150573_1_, Random p_150573_2_,
		...
		genBiomeModdedTerrain(p_150573_1_, p_150573_2_, p_150573_3_,
	 ...
	 * @param z
	 */
	public void genBiomeModdedTerrain(World world, Random random,
			Block[] replacableBlock, byte[] aByte, int x, int y, double z) {
