...
public class MapGenCaveElysian extends MapGenBase {
                            ...
                            for (j3 = k4; j3 < j2; ++j3) {
                                ...
                                for (int l3 = i2 - 1; l3 >= j4; --l3) {
                                    ...
                                    if (d12 > -0.7D && d13 * d13 + d12 * d12 + d14 * d14 < 1.0D) {
                                        ...
                                        if (isTopBlock(p_151543_5_, k3, k2, l3, j3, p_151543_3_, p_151543_4_)) {
                                            flag1 = true;
                                        }
                                        digBlock(p_151543_5_, k3, k2, l3, j3, p_151543_3_, p_151543_4_, flag1);
                                    }
    ...
    // Determine if the block at the specified location is the top block for the biome, we take
    // into account
     ...
     * Sets the block to lava if y is less then 10, and air other wise. If setting to air, it
     * also checks to see if we've broken the surface and if so tries to make the floor the
     * biome's top block
     * 
     ...
     * @param foundTop True if we've encountered the biome's top block. Ideally if we've broken
     *            the surface.
     */
