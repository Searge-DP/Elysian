...
public class CopyOfChunkProviderElysian implements IChunkProvider {
    ...
    private MapGenBase elysianCaveGenerator = new MapGenCavesHell(); // update : this has
                                                                     // nothing to do with the
                                                                     // noise that generates
                                                                     // the terrain ... (derp
                                                                     // me)
    ...
    public Chunk provideChunk (int posX, int posZ) {
        ...
        this.worldObj.getWorldChunkManager().loadBlockGeneratorData((BiomeGenBase[])null, posX * 16, posZ * 16, 16, 16);
    ...
    private double[] initializeNoiseField (double[] noiseField, int posX, int posY, int posZ, int sizeX, int sizeY, int sizeZ) {
        ...
        // ChunkProviderEvent.InitNoiseField(this, noiseField, posX, posY, posZ, sizeX, sizeY,
        // sizeZ);
