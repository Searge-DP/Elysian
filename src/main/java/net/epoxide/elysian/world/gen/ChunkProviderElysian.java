...
public class ChunkProviderElysian implements IChunkProvider {
    ...
    public void generateNetherTerrain(int par1, int par2, Block[] blocks) {
        ...
        BiomeGenBase biome = worldObj.getBiomeGenForCoords(par1, par2);
        byte b0 = 4;
        byte b1 = 32;
        int k = b0 + 1;
        byte b2 = 17;
                        ...
                        if (b3 == Blocks.air) {
                            ...
                            if (j1 == -1) {
                                if (i1 <= 0) {
                                    ...
                                    b1 = biome.fillerBlock;
                                    b2 = biome.fillerBlock;

                                    if (flag1) {
                                        b1 = Blocks.gravel; //TODO add to biome
                                    }
                                    ...
                                    if (flag) {
                                        b1 = Blocks.soul_sand; //TODO add to biome
                                    }

                                    if (flag) {
                                        b2 = Blocks.soul_sand; //TODO add to biome
                                    }
                                }

                                if (k1 < b0 && b1 == Blocks.air) {
                                    b1 = Blocks.air; //TODO add to biome
                                }
    ...
    private double[] initializeNoiseField(double[] par1ArrayOfDouble, int par2, int par3, int par4, int par5, int par6, int par7) {
        ...
        // ChunkProviderEvent.InitNoiseField(this, par1ArrayOfDouble, par2,
    ...
    public void populate(IChunkProvider par1IChunkProvider, int par2, int par3) {
        ...
        int k = par2 * 16;
        int l = par3 * 16;
        worldObj.getBiomeGenForCoords(k + 16, l + 16);
     ...
     */
    // @Override
    // public ChunkPosition findClosestStructure(World par1World, String
    // par2Str, int par3, int par4, int par5)
    // {
    // return null;
    // }
