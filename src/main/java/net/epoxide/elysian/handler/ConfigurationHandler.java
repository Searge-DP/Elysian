...
public class ConfigurationHandler {
    ...
    private void syncConfigData () {
        ...
        dimensionID = config.getInt("dimensionID", Configuration.CATEGORY_GENERAL, DimensionManager.getNextFreeDimId(), -10000, 10000, "The dimension ID for the Elysian dimension. If you have succesfully launched a world with the Elysian mod once, do not change this!");
