...
public class RenderElysianEnvCreature extends RenderLiving {
    ...
    public void renderCreature (EntityEnvironementCreature entity, double par2, double par4, double par6, float par8, float par9) {
    ...
    public void doRenderLiving (EntityLiving par1EntityLiving, double par2, double par4, double par6, float par8, float par9) {
        ...
        this.renderCreature((EntityEnvironementCreature) par1EntityLiving, par2, par4, par6, par8, par9);
    }
    
    @Override
    public void doRender (Entity par1Entity, double par2, double par4, double par6, float par8, float par9) {
    
        this.renderCreature((EntityEnvironementCreature) par1Entity, par2, par4, par6, par8, par9);
    }
