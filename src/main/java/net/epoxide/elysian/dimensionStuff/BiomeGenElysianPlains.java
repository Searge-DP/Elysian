...
public class BiomeGenElysianPlains extends BiomeGenBase {
    ...
    public BiomeGenElysianPlains(int par1) {
        ...
        // BiomeGenBase.SpawnListEntry(EntityGreenDragon.class, 1, 1, 1));
        // this.spawnableCaveCreatureList.add(new
        // BiomeGenBase.SpawnListEntry(EntityElysianDragonfly.class, 1, 1, 1));
        // this.spawnableCaveCreatureList.add(new
        // BiomeGenBase.SpawnListEntry(EntityEnvironementCreature.class, 5, 5, 10));
