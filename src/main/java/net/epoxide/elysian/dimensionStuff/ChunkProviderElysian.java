...
public class ChunkProviderElysian implements IChunkProvider {
                    ...
                    for (int l1 = 0; l1 < 8; ++l1) {
                        ...
                        for (int i2 = 0; i2 < 4; ++i2) {
                            ...
                            for (int k2 = 0; k2 < 4; ++k2) {
                                ...
                                if (d15 > 0.0D) {
                                    block = Blocks.stone; // TODO custom environement block
                                }
            ...
            for (int l = 0; l < 16; ++l) {
                ...
                for (int k1 = 127; k1 >= 0; --k1) {
                    ...
                    if (k1 < 127 - this.rand.nextInt(5) && k1 > 0 + this.rand.nextInt(5)) {
                        ...
                        p_147418_3_[l1] = Blocks.planks; // we want bedrock ? //TODO custom
                                                         // block
                    }
                }
            }
    ...
    public void populate (IChunkProvider p_73153_1_, int p_73153_2_, int p_73153_3_) {
        ...
        // (new WorldGenHellLava(Blocks.flowing_water, true)).generate(this.worldObj,
        // this.rand, l1, i2, j2);
        // }
