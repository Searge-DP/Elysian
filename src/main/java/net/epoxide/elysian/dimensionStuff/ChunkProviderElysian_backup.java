...
public class ChunkProviderElysian_backup implements IChunkProvider {
	...
	//=============Copied ChunkProvied from old Elysian code. The tutorial had outdated code :/ (still working with block id's) ====================//
...
//		}
		...
		//TODO, leaving these two events out. we currently have no decoration in our biomes and/or dimension. 
