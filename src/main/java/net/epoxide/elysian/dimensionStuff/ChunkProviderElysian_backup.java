...
public class ChunkProviderElysian_backup implements IChunkProvider {
    
    // =============Copied ChunkProvied from old Elysian code. The tutorial had outdated code
    // :/ (still working with block id's) ====================//
    ...
    public ChunkProviderElysian_backup(World par1World, long par2) {
                    ...
                    for (int l1 = 0; l1 < 8; ++l1) {
                        ...
                        for (int i2 = 0; i2 < 4; ++i2) {
                            ...
                            for (int k2 = 0; k2 < 4; ++k2) {
                                ...
                                if (k1 * 8 + l1 < b1 + 3)
                                    l2 = Blocks.water; // TODO add custom block
                                    
                                if (d15 > 0.0D)
                                    l2 = Blocks.grass; // TODO add custom block
            ...
            for (int l = 0; l < 16; ++l) {
                ...
                for (int k1 = 127; k1 >= 0; --k1) {
                    ...
                    if (k1 < 127 - random.nextInt(5) && k1 > 0 + random.nextInt(5)) {
                        ...
                        if (b3 == Blocks.air)
                            j1 = -1;
                        else if (b3 == Blocks.clay) // TODO add custom block
                            if (j1 == -1) {
                                if (i1 <= 0) {
                                    b1 = Blocks.air;
                                    b2 = Blocks.clay;// TODO add custom block
                                }
                                else if (k1 >= b0 - 4 && k1 <= b0 + 1) {
                                    b1 = Blocks.gold_block; // TODO add custom block
                                    b2 = Blocks.iron_block; // TODO add custom block
    ...
    public void populate (IChunkProvider par1IChunkProvider, int par2, int par3) {
        ...
        // TODO add custom minables
        // WorldGenMinable worldgenminable = new WorldGenMinable(ElysianBlocks.essence, 5,
        // ElysianBlocks.stone);
        // WorldGenPileOfRocks rocks = new WorldGenPileOfRocks(false);
        
        int x, y, z;
        // TODO add custom minables and generation
        // for (int i = 0; i < 8; ++i) {
        ...
        // TODO, leaving these two events out. we currently have no decoration in our biomes
        // and/or dimension.
        // MinecraftForge.EVENT_BUS.post(new DecorateBiomeEvent.Post(worldObj, random, xGen,
        // zGen));
        // MinecraftForge.EVENT_BUS.post(new PopulateChunkEvent.Post(par1IChunkProvider,
        // worldObj, random, par2, par3, false));
